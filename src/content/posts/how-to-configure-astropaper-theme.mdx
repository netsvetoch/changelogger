...
AstroPaper uses Astro's [fonts API](https://docs.astro.build/en/guides/fonts/) with [Inter](https://fonts.google.com/specimen/Inter) for interface and article text, [Montserrat](https://fonts.google.com/specimen/Montserrat) for headings, and [JetBrains Mono](https://fonts.google.com/specimen/JetBrains+Mono) for code. This provides consistent typography across all platforms with automatic font optimizations including preloading and caching.

### Using the default font

The fonts are automatically configured in `astro.config.ts` and loaded in `Layout.astro`. No additional configuration is needed to use the default typography stack.

### Customizing the font

To use a different font stack, update three places:
...
export default defineConfig({
  ...
  fonts: [
    {
      name: "Your Interface Font", // [!code highlight]
      cssVariable: "--font-your-interface-font", // [!code highlight]
...
<head>
  <!-- ... -->
  <Font
    cssVariable="--font-your-interface-font"
...
@theme inline {
  --font-app: var(--font-your-interface-font); /* [!code highlight] */
  --font-heading: var(--font-your-heading-font);
  --font-mono: var(--font-your-mono-font);
  /* ... */
}
```

The `--font-app`, `--font-heading`, and `--font-mono` variables are used throughout the theme via Tailwind font utilities, so updating these variables applies your custom typography consistently.
